...
namespace TheRecrutmentTool.Data.Migrations
{
    ...
    [Migration("20220120182258_JobInterviewRelations")]
    partial class JobInterviewRelations
    {
            ...
            modelBuilder.Entity("TheRecrutmentTool.Data.Models.Interview", b =>
                {
                    ...
                    b.Property<string>("SuitableCandidateId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("SuitableCandidateId");
            ...
            modelBuilder.Entity("TheRecrutmentTool.Data.Models.Interview", b =>
                {
                    ...
                    b.HasOne("TheRecrutmentTool.Data.Models.Candidate", "SuitableCandidate")
                        .WithMany()
                        .HasForeignKey("SuitableCandidateId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("Job");

                    b.Navigation("SuitableCandidate");
                });
